...
{
    /// <summary>
    /// Calculates ATR by using a local function  in the TrueRange function
    /// </summary>
    public static class AverageTrueRange_LocalFunction
    {
        ...
        public static List<Quote> CalculateAverageTrueRange_LocalFunction(HistoricalValue[] Price, int Length)
        {
